...
/*   User Template */
$template['cpage']['template'] = 'template_cpage';
$template['cpage']['regions'] = array(
   'menu',
   'content',
);
$template['cpage']['parser'] = 'parser';
$template['cpage']['parser_method'] = 'parse';
$template['cpage']['parse_template'] = FALSE;
